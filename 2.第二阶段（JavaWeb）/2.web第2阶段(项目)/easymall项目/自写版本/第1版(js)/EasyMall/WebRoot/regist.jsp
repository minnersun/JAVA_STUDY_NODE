...
<html>
	...
	<body>
		...
		<form action="<%=request.getContextPath() %>/RegictServlet" method="POST" onsubmit="return formObj.checkForm()">
			...
			<table>
				<tr>
				<td colspan="2" style="text-align: center;"><font color="red" size="2" >	<%=request.getAttribute("msg")==null?"":request.getAttribute("msg") %>	</font></td>
				</tr>
				<tr>
					<td class="tds">用户名：</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<img name="img" src="<%=request.getContextPath() %>/VlidateServlet" width="" height="" alt="此处是验证码" /><span></span>
					</td>
				</tr>
				<tr>
